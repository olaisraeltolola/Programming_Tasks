...
"""
			options_under_tones = int(input(tones_menu))
...
"""
					functions_under_phone_settings = int(input(options_under_phone_settings))
...
"""
			options_under_music = int(input(music_menu))	
...
"""
			options_under_clock = int(input(clock_menu))
